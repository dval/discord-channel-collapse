...
window.addEventListener('load', function () {
    setTimeout(function () {
        ...
        let toolbar = document.querySelector('.toolbar__62fb5');
        ...
        icon.classList.add('iconWrapper_af9215', 'clickable_c30925');
        ...
        icon.addEventListener('click', () => {
            const sidebar = document.querySelector('.sidebar_e031be');
        ...
        setInterval(function () {
            ...
            toolbar = document.querySelector('.toolbar__62fb5');
